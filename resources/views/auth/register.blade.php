                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group row form-row">
                                    <label for="name"
                                           class="col-md-4 col-form-label text-md-right"><i
                                            class="fas fa-user"></i> {{ __('Name') }}</label>
                                ...
                                <div class="form-group row form-row">
                                    <label for="email"
                                           class="col-md-4 col-form-label text-md-right"><i
                                            class="far fa-envelope"></i> {{ __('E-Mail Address') }}</label>
                                ...
                                <div class="form-group row form-row">
                                    <label for="password"
                                           class="col-md-4 col-form-label text-md-right"><i
                                            class="fas fa-key"></i> {{ __('Password') }}</label>
                                ...
                                <div class="form-group row form-row">
                                    <label for="password-confirm"
                                           class="col-md-4 col-form-label text-md-right"><i
                                            class="fas fa-key"></i> {{ __('Confirm Password') }}</label>
